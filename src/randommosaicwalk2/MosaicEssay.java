...
//        fillWithRandomColors();
   ...
   //         changeToRandomColor(currentRow, currentColumn);
            changeToMoreGreen(currentRow, currentColumn);
            randomMove();
            Mosaic.delay(20);
        }
    }  // end main
    ...
    static void fillWithSolidColor() {
        for (int row = 0; row < ROWS; row++) {
            for (int column = 0; column < COLUMNS; column++) {
    ...
    static void changeToMoreGreen(int rowNum, int colNum) {
